...
class TestReviewFunctions(TestReviewXBlock):
    ...
    def test_review_problem_urls(self, num_desired):
        ...
        expected_urls = [
            (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_1', True, 0),
            (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_2', True, 0),
            (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_3', True, 0),
            (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_4', True, 0),
            (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_5', True, 0),
            (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_6', True, 0)
        ]
    ...
    def test_review_problem_urls_unique_problem(self, num_desired):
        ...
        expected_not_loaded_problem = (url_beginning + 'i4x://DillonX/DAD101x/problem/Problem_5', True, 0)
